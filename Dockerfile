...
RUN cd / && curl -sS https://getcomposer.org/installer | /usr/bin/php5 && /usr/bin/php5 /composer.phar selfupdate 1.3.2

RUN apk add --no-cache nodejs ca-certificates openssl \
